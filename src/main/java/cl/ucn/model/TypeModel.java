...
public class TypeModel {
    ...
    public void setExtendsTypes(List<String> extendsTypes) { this.extendsTypes = extendsTypes; }

    public List<String> getImplementsTypes() { return implementsTypes; }
    public void setImplementsTypes(List<String> implementsTypes) { this.implementsTypes = implementsTypes; }
    ...
    public void setMethods(List<MethodModel> methods) { this.methods = methods; }
}
